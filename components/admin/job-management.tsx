...
import type { JobListing } from "@/lib/job-scraper"
    ...
    try {
      const jobData = {
        ...
        importantDates: {
          ...
          applicationEnd: formData.lastDate,
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold">{jobs.reduce((sum, job) => sum + job.posts, 0)}</div>
                  ...
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => toggleJobStatus(job.id, !isExpired)}
                        className={`bg-transparent ${isExpired ? "text-green-600" : "text-orange-600"}`}
                      >
                        {isExpired ? <CheckCircle className="h-4 w-4" /> : <XCircle className="h-4 w-4" />}
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Tabs defaultValue="basic" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="dates">Dates & Fee</TabsTrigger>
              </TabsList>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({ ...prev, posts: Number.parseInt(e.target.value) || 1 }))
                      }
                      required
                    />
                  </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData((prev) => ({ ...prev, applicationStart: e.target.value }))}
                      required
                    />
                  </div>
                  <div className="space-y-2">
